      ...
      <div className="about-content">
        <div className="profile-image">
          ...
          <div className="social-links">
            ...
            <a href="mailto:forrest.tindall@gmail.com" rel="noopener noreferrer">
        ...
        <div className="bio-content">
          <h1>About Me</h1>
          <p>
            I've been a photographer since 2004, originally starting with film. After a few years, I transitioned to digital photography, and since then, I've been capturing the world in a way that's both beautiful and functional. When I became a knifemaker, I needed high-quality images of my work, but photography quickly became more than just a tool—it became the focus. Now, I specialize in outdoor commercial photography, working with brands that live at the intersection of craftsmanship and the wild.
          </p>
          <p>
          ...
          <p>
            Based in Boise, Idaho, I travel often. The best part of this work is being forced to slow down, to see places differently, and to translate that perspective into something tangible. Outside of photography, I spend my time fly fishing, programming, making art and exploring through wardriving.
          </p>
